...
extension SearchTrainViewController:UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "train", for: indexPath) as? TrainInfoCell {
            ...
            if let trainCode = UserDefaults.standard.value(forKey: "Fav") as? String {
                cell.starButton.isSelected = trainCode == train.trainCode
            }
            ...
            cell.starButtonTap = {
                UserDefaults.standard.setValue(train.trainCode, forKey: "Fav")
